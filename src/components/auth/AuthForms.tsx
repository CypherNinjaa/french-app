...
export function LoginForm({ onToggleMode }: LoginFormProps) {
	...
	return (
		<div className="card mx-auto" style={{ maxWidth: "28rem" }}>
			<h2 className="h3 text-center mb-4">Sign In</h2>
				...
				<div className="mb-3">
					...
					<div className="position-relative">
						...
						<button
							...
							className="btn position-absolute top-50 translate-middle-y border-0 bg-transparent text-muted"
							style={{ right: "8px" }}
							disabled={loading}
						>
							{showPassword ? (
...
export function SignUpForm({ onToggleMode }: LoginFormProps) {
	...
	return (
		<div className="card mx-auto" style={{ maxWidth: "28rem" }}>
			<h2 className="h3 text-center mb-4">Create Account</h2>
